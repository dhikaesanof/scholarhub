<div class="space-y-8">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-3xl font-semibold text-slate-950">Add New Scholarship</h1>
            <p class="text-slate-600 mt-1">Isi semua informasi beasiswa dengan lengkap sebelum dipublikasikan.</p>
        </div>
    ...
    <form wire:submit.prevent="save" class="space-y-8 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <section class="space-y-5">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    @error('funding_type') <p class="mt-2 text-sm text-rose-600">{{ $message }}</p> @enderror
                </div>
                <div>
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:justify-end">
            <button type="submit" class="rounded-3xl bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">Save Scholarship</button>
